...
import { Home, Bell, Plus, FileText, User, ThumbsUp, ArrowLeft } from 'lucide-react';
import { Button } from '@/components/ui/button';

export function VotedComplaintsMockup() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4 bg-slate-50 dark:bg-slate-900">
      ...
      <div className="mb-4 text-center">
        <h3 className="text-lg font-black text-slate-800 dark:text-white">Voted Complaints Mockup</h3>
      ...
      <div className="w-[375px] h-[720px] rounded-[3rem] border-4 border-dashed border-blue-500 bg-white shadow-2xl flex flex-col overflow-hidden relative select-none">
        ...
        <div className="flex-1 bg-[#F0F0F5] flex flex-col items-center justify-center p-6 relative">
          ...
          <div className="flex flex-col items-center text-center -mt-12">
            <div className="w-[70px] h-[70px] rounded-full bg-purple-100 flex items-center justify-center shadow-inner mb-4 transition-transform hover:scale-105 duration-300">
              <ThumbsUp className="w-9 h-9 text-[#6B3EE8] fill-[#6B3EE8]/10" />
            </div>
...
export default VotedComplaintsMockup;
