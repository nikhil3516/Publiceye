  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4 bg-slate-50 dark:bg-slate-900">
      ...
      <div className="mb-4 text-center">
        <h3 className="text-lg font-black text-slate-800 dark:text-white">Posted Complaints Mockup</h3>
      ...
      <div className="w-[375px] h-[720px] rounded-[3rem] border-4 border-dashed border-blue-500 bg-white shadow-2xl flex flex-col overflow-hidden relative select-none">
        ...
        {/* Mockup Body */}
        <div className="flex-1 bg-[#F0F0F5] flex flex-col items-center justify-center p-6 relative">
          
          {/* Centered Empty State Content */}
          <div className="flex flex-col items-center text-center -mt-8">
            
            {/* Thematic Illustration: 2x2 Grid of orange squares */}
            <div className="grid grid-cols-2 gap-[8px] mb-6 relative">
              
              {/* Box 1 (Top Left) */}
              <div className="w-[70px] h-[70px] bg-[#FF6D00] rounded-xl shadow-md flex items-center justify-center">
                <FileText className="w-8 h-8 text-white/90" />
              </div>
              
              {/* Box 2 (Top Right) with overlapping Red Exclamation Badge */}
              <div className="w-[70px] h-[70px] bg-[#FF6D00] rounded-xl shadow-md flex items-center justify-center relative">
                <FileText className="w-8 h-8 text-white/90" />
                {/* Red Badge */}
                <div className="absolute -top-[7px] -right-[7px] w-[22px] h-[22px] rounded-full bg-red-600 border border-white flex items-center justify-center text-white text-[11px] font-black shadow-md animate-bounce">
                  !
                </div>
              </div>
            ...
            {/* Thinking Face Avatar Circle */}
            <div className="w-[70px] h-[70px] rounded-full bg-orange-100 border border-orange-200 flex items-center justify-center shadow-inner mb-4 transition-transform hover:scale-105 duration-300">
              <span className="text-3xl" role="img" aria-label="thinking face">🤔</span>
            </div>

            {/* Muted Text */}
            <p className="text-sm font-bold text-slate-500 tracking-tight">No Records Found - Yet.</p>
          </div>
