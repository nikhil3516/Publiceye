...
export function YourActivityMockup() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4 bg-slate-50 dark:bg-slate-900">
      ...
      <div className="mb-4 text-center">
        <h3 className="text-lg font-black text-slate-800 dark:text-white">Your Activity Mockup</h3>
      ...
      <div className="w-[375px] h-[720px] rounded-[3rem] border-4 border-dashed border-blue-500 bg-white shadow-2xl flex flex-col overflow-hidden relative select-none">
        ...
        <div className="h-16 bg-[#F15A24] px-4 flex items-center justify-between text-white relative shadow-md">
          {/* Back arrow inside slightly darker orange rounded square button */}
          <button 
            onClick={() => navigate('/home/complaints')}
            className="w-10 h-10 flex items-center justify-center bg-[#E8501A] hover:bg-[#d64310] rounded-xl active:scale-95 transition-all"
          >
        ...
        <div className="flex-1 bg-[#F0F0F5] flex flex-col items-center p-6 relative">
          ...
          <div className="flex flex-col items-center text-center mt-28">
            <div className="w-[75px] h-[75px] rounded-full bg-[#FDE8D8] flex items-center justify-center shadow-inner mb-5 transition-transform hover:scale-105 duration-300">
              {/* User/person profile icon in orange outline style, ~32px */}
              <User className="w-[32px] h-[32px] text-[#F15A24]" strokeWidth={2} />
            </div>
...
export default YourActivityMockup;
